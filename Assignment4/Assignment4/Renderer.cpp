...
void Renderer::nanogui_init(GLFWwindow* window)
{
    ...
    gui_1->addVariable("Catmull-Rom curve on/off", m_curve->curve_on);
    
    gui_1->addGroup("Aircraft Animation");
    gui_1->addVariable("Aircraft is moving", m_aircraft_animation->is_moving);
...
{
	Shader m_shader = Shader("/Users/priscillalin/OpenGL/CS6323/Assignment4/Assignment4/shader/basic.vert", "/Users/priscillalin/OpenGL/CS6323/Assignment4/Assignment4/shader/basic.frag");
...
{
	obj_list.clear();
	Object cube_object("/Users/priscillalin/OpenGL/CS6323/Assignment4/Assignment4/objs/cube.obj");
	cube_object.obj_color = glm::vec4(1.0, 1.0, 0.0, 1.0);
	cube_object.obj_name = "cube";

	Object plane_object("/Users/priscillalin/OpenGL/CS6323/Assignment4/Assignment4/objs/plane.obj");
	plane_object.obj_color = glm::vec4(0.5, 0.5, 0.5, 1.0);
	plane_object.obj_name = "plane";

	Object arrow_object("/Users/priscillalin/OpenGL/CS6323/Assignment4/Assignment4/objs/arrow.obj");
	arrow_object.obj_name = "axis_arrow";

	Object aircraft_object("/Users/priscillalin/OpenGL/CS6323/Assignment4/Assignment4/objs/aircraft.obj");
	...
	for (size_t i = 0; i < obj_list.size(); i++)
	{
		if (obj_list[i].obj_name == "cube")
		{
            ...
            for (unsigned int j = 0; j < m_curve->control_points_pos.size(); j++) {
                ...
                cur_obj_model_mat = m_curve->rotate_cube(cur_obj_model_mat, j);
...
void Renderer::curve_switch()
{
    
    if(m_curve->curve_on == true && obj_list.size() == 4) {
        //m_curve->calculate_curve();
        Object curve_object(m_curve->curve_points_pos);
        curve_object.m_render_type = RENDER_LINES;
        curve_object.obj_color = glm::vec4(1.0, 0.0, 0.0,1.0);
    ...
    else if(m_curve->curve_on == false && obj_list.size() == 5 ) {
        obj_list.pop_back();
    }
}
