...
void Renderer::nanogui_init(GLFWwindow* window)
{
    ...
    //-------------- screen-> doRotation  (by Ju-Chen Lin
    
    gui_1->addGroup("Rotation");
    gui_1->addVariable("Rotate Angle a", m_animation->angle_a)->setSpinnable(true);
    gui_1->addVariable("Rotate Angle b", m_animation->angle_b)->setSpinnable(true);
    
    gui_1->addButton("Rotate Local X", []() {
        //m_animation->rotateLocal( (GLfloat)angle_a );
        m_animation->rotateLocal();
    });
    
    gui_1->addButton("Rotate Global Y", []() {
        //m_animation->rotateGlobal( (GLfloat)angle_b );
        m_animation->rotateGlobal();
    });
...
{
	Shader m_shader = Shader("/Users/priscillalin/OpenGL/CS6323/Assignment1/Assignment1/shader/basic.vert", "/Users/priscillalin/OpenGL/CS6323/Assignment1/Assignment1/shader/basic.frag");
...
{
	obj_list.clear();
	Object main_object("/Users/priscillalin/OpenGL/CS6323/Assignment1/Assignment1/objs/bunny.obj");
	main_object.obj_color = glm::vec4(0.7, 0.7, 0.7, 1.0);
	main_object.obj_name = "main_object";

	Object plane_object("/Users/priscillalin/OpenGL/CS6323/Assignment1/Assignment1/objs/plane.obj");
	plane_object.obj_color = glm::vec4(0.5, 0.5, 0.5, 1.0);
	plane_object.obj_name = "plane";

	Object arrow_object("/Users/priscillalin/OpenGL/CS6323/Assignment1/Assignment1/objs/arrow.obj");
